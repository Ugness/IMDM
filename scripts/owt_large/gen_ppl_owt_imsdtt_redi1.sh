steps=${1:-1024}
checkpoint_path=${2:-"./outputs/owt_large/imsdtt_noisedim2048_redi1.ckpt"}
output_path=${3:-"./results/owt_large"}
noise_dim=${4:-2048}

generated_samples_path=$output_path/samples/$steps-IMSDTT_ReDi1-gpt2.json
